...
export const ChatItemDefault = ({
  ...
  return (
    <div className="relative group flex flex-row items-center hover:bg-foreground/5 p-4 transition w-full max-w-full justify-start min-w-0">
      <div className="group flex flex-row gap-x-2 items-start justify-start w-full max-w-full min-w-0">
        <div className="flex flex-row gap-x-2 items-center justify-start flex-shrink-0">
        ...
        <div className="flex flex-col w-full max-w-full gap-1 items-start justify-start min-w-0">
          <div className="flex flex-row gap-x-2 items-center justify-between w-full max-w-full min-w-0">
            <div className="flex flex-row gap-2 items-center justify-start min-w-0">
              <button
                onClick={onMemberClick}
                className="font-semibold text-xs hover:underline cursor-pointer whitespace-nowrap flex-shrink-0"
              >
